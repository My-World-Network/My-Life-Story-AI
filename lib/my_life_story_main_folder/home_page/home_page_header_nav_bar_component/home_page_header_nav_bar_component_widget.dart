...
import 'home_page_header_nav_bar_component_model.dart';
export 'home_page_header_nav_bar_component_model.dart';

class HomePageHeaderNavBarComponentWidget extends StatefulWidget {
  const HomePageHeaderNavBarComponentWidget({super.key});

  @override
  State<HomePageHeaderNavBarComponentWidget> createState() =>
      _HomePageHeaderNavBarComponentWidgetState();
}

class _HomePageHeaderNavBarComponentWidgetState
    extends State<HomePageHeaderNavBarComponentWidget>
    with TickerProviderStateMixin {
  late HomePageHeaderNavBarComponentModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => HomePageHeaderNavBarComponentModel());
