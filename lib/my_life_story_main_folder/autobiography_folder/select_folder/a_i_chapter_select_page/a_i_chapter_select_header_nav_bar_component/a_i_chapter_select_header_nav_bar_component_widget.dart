...
import 'a_i_chapter_select_header_nav_bar_component_model.dart';
export 'a_i_chapter_select_header_nav_bar_component_model.dart';

class AIChapterSelectHeaderNavBarComponentWidget extends StatefulWidget {
  const AIChapterSelectHeaderNavBarComponentWidget({super.key});

  @override
  State<AIChapterSelectHeaderNavBarComponentWidget> createState() =>
      _AIChapterSelectHeaderNavBarComponentWidgetState();
}

class _AIChapterSelectHeaderNavBarComponentWidgetState
    extends State<AIChapterSelectHeaderNavBarComponentWidget>
    with TickerProviderStateMixin {
  late AIChapterSelectHeaderNavBarComponentModel _model;
                                                                    ...
                                                                    onPressed:
                                                                      ...
                                                                      if (() {
                                                                        ...
                                                                        await Future.delayed(const Duration(
                                                                            milliseconds:
                                                                                200));
                                                                        if (animationsMap['blurOnActionTriggerAnimation1'] !=
                                                                            null) {
                                                                          await animationsMap['blurOnActionTriggerAnimation1']!
                                                                              .controller
                                                                              .forward(from: 0.0);
                                                                        }
                                                                        if (animationsMap['blurOnActionTriggerAnimation2'] !=
                                                                            null) {
