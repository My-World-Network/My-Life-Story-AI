...
import 'a_b_select_header_nav_bar_component_model.dart';
export 'a_b_select_header_nav_bar_component_model.dart';

class ABSelectHeaderNavBarComponentWidget extends StatefulWidget {
  const ABSelectHeaderNavBarComponentWidget({super.key});

  @override
  State<ABSelectHeaderNavBarComponentWidget> createState() =>
      _ABSelectHeaderNavBarComponentWidgetState();
}

class _ABSelectHeaderNavBarComponentWidgetState
    extends State<ABSelectHeaderNavBarComponentWidget>
    with TickerProviderStateMixin {
  late ABSelectHeaderNavBarComponentModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ABSelectHeaderNavBarComponentModel());
