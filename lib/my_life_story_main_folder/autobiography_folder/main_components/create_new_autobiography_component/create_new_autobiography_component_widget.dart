        ...
        child: BackdropFilter(
          ...
          child: Align(
            ...
            child: Container(
              ...
              decoration: BoxDecoration(
                color: FlutterFlowTheme.of(context).navFade5,
                                ...
                                FFButtonWidget(
                                  onPressed: () async {
                                    var autobiographiesRecordReference =
                                        AutobiographiesRecord.collection.doc();
                                    await autobiographiesRecordReference.set({
                                      ...createAutobiographiesRecordData(
                                        autobiographyUID: currentUserReference,
                                      ),
                                      ...mapToFirestore(
                                        {
                                    ...
                                    await userChaptersRecordReference.set({
                                      ...createUserChaptersRecordData(
                                        userChapterNumber: 1,
                                        userChapterUID: currentUserReference,
                                    ...
                                    _model.backendCreateUserChapters =
                                        UserChaptersRecord.getDocumentFromData({
                                      ...createUserChaptersRecordData(
                                        userChapterNumber: 1,
                                        userChapterUID: currentUserReference,
                                        autobiographyRef: _model
                                    ...
                                    var userAutobiographyRecordReference =
                                        UserAutobiographyRecord.createDoc(_model
                                            .backendCreateAutobiography!
                                            .reference);
                                    await userAutobiographyRecordReference.set({
                                    ...
                                    _model.backendCreateAIChapters =
                                        AIChaptersRecord.getDocumentFromData({
                                      ...createAIChaptersRecordData(
                                        aIChapterNumber: 1,
                                        aIChapterUID: currentUserReference,
                                        autobiographyRef: _model
                                    ...
                                    var aIAutobiographyRecordReference =
                                        AIAutobiographyRecord.createDoc(_model
                                            .backendCreateAutobiography!
                                            .reference);
                                    await aIAutobiographyRecordReference.set({
                                    ...
                                    var aIInstructionsRecordReference =
                                        AIInstructionsRecord.createDoc(_model
                                            .backendCreateAutobiography!
                                            .reference);
                                    await aIInstructionsRecordReference.set({
                                      ...createAIInstructionsRecordData(
                                        aIInstructionsUID: currentUserReference,
                                        aIInstructionsAutobiographyREF: _model
                                            .backendCreateAutobiography
                                            ?.reference,
                                    ...
                                    await _model
                                        .backendCreateAutobiography!.reference
                                        .update({
                                      ...createAutobiographiesRecordData(
                                        userAutobiographyRef: _model
