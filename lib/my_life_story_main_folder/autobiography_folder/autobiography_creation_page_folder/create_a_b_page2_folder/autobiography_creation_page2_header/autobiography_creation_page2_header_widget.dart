...
import 'autobiography_creation_page2_header_model.dart';
export 'autobiography_creation_page2_header_model.dart';

class AutobiographyCreationPage2HeaderWidget extends StatefulWidget {
  const AutobiographyCreationPage2HeaderWidget({
    super.key,
  ...
  @override
  State<AutobiographyCreationPage2HeaderWidget> createState() =>
      _AutobiographyCreationPage2HeaderWidgetState();
}

class _AutobiographyCreationPage2HeaderWidgetState
    extends State<AutobiographyCreationPage2HeaderWidget>
    with TickerProviderStateMixin {
  late AutobiographyCreationPage2HeaderModel _model;
                                                                        ...
                                                                        onPressed:
                                                                          ...
                                                                          await widget
                                                                            ...
                                                                            autobiographyCoverColour:
                                                                                FFAppState().createAutobiographyCoverColour,
